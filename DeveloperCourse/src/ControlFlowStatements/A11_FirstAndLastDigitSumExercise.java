...
//the first digit and the last digit is 0 since we only have 1 digit, which gives us 0+0 and the sum is 0.
//* sumFirstAndLastDigit(5); should return 10, 
//the first digit and the last digit is 5 since we only have 1 digit, which gives us 5+5 and the sum is 10.
//* sumFirstAndLastDigit(-10); should return -1, since the parameter is negative and needs to be positive.
//NOTE: The method sumFirstAndLastDigit needs to be defined as public static.
//NOTE: Do not add a  main method to solution code.
public class A11_FirstAndLastDigitSumExercise {

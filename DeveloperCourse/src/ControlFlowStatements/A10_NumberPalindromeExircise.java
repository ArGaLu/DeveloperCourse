...
//Tip: Be careful with reversing a number, you will need a parameter for comparing a reversed number with 
//the starting number (parameter).
//NOTE: The method isPalindrome needs to be defined as public static

public class A10_NumberPalindromeExircise {
	public static void main(String[] args) {

		System.out.println(isPalindrome(-212));
	}
	public static boolean isPalindrome (int number) {
		int reverse = 0, lastDigit, origin;
		if (number<0){
		    number *= -1;
		}
		origin = number;
